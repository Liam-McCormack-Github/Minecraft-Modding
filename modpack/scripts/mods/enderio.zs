...
SliceNSplice.addRecipe(<deepmoblearning:data_model_wither>, [<techguns:itemshared:66>, <deepmoblearning:data_model_blank>, <techguns:itemshared:66>, <ore:itemPrecientPowder>, <mysticalagradditions:nether_star_essence> | <draconicevolution:mob_soul>.withTag({EntityName: "minecraft:wither", display: {LocName: "Wither Soul"}}), <ore:itemEnderCrystalPowder>], 1000000, 100);
SliceNSplice.addRecipe(<deepmoblearning:data_model_dragon>, [<techguns:itemshared:66>, <deepmoblearning:data_model_blank>, <techguns:itemshared:66>, <ore:itemEnderCrystalPowder>, <mysticalagradditions:dragon_egg_essence> | <draconicevolution:mob_soul>.withTag({EntityName: "minecraft:ender_dragon", display: {LocName: "Ender Dragon Soul"}}), <ore:itemEnderCrystalPowder>], 1000000, 25);
