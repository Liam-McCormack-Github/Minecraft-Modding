...
Enchanter.addRecipe(<extrautils2:ingredients:12>, <minecraft:gold_ingot>, <actuallyadditions:item_solidified_experience> * 8, 4000, 1250, false);
Enchanter.addRecipe(<extrautils2:simpledecorative>, <minecraft:gold_block>, <actuallyadditions:item_solidified_experience> * 72, 256000, 10000, false);
Enchanter.addRecipe(<extendedcrafting:storage:2>, <mysticalagriculture:growth_accelerator>, <mysticalagradditions:special>, 256000, 10000, false);
Enchanter.addRecipe(<minecraft:dragon_egg>, <mysticalagriculture:growth_accelerator>, <mysticalagradditions:special:1>, 256000, 10000, false);
Enchanter.addRecipe(<draconicevolution:draconic_block>, <mysticalagriculture:growth_accelerator>, <mysticalagradditions:special:4>, 256000, 10000, false);
Enchanter.addRecipe(<avaritia:block_resource>, <mysticalagriculture:growth_accelerator>, <mysticalagradditions:special:5>, 256000, 10000, false);
...
Enchanter.addRecipe(<mysticalagriculture:growth_accelerator>, <minecraft:diamond_block>, <mysticalagriculture:crafting:50>, 4000, 1000, false);
Enchanter.addRecipe(<extrautils2:ingredients:5> * 9, <thermalfoundation:coin:71> * 9, <zcontent:meteor_dust>, 32000, 10000, false);
Sawmill.addRecipe(<extrautils2:endershard> * 8, <minecraft:ender_pearl>, 2000);
Sawmill.addRecipe(<zcontent:silicon_wafer> * 9, <zcontent:silicon_boule>, 2000);
Sawmill.addRecipe(<extendedcrafting:material:2> * 4, <jaopca:item_platedenseblackiron>, 2000);
...
Factorizer.addRecipeBoth(<zcontent:xp_block>, <actuallyadditions:item_solidified_experience> * 100);
