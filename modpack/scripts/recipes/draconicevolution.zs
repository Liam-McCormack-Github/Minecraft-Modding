...
recipes.addShaped(<draconicevolution:mob_soul>.withTag({EntityName: "minecraft:wither"}), [[<minecraft:skull:1>, <minecraft:skull:1>, <minecraft:skull:1>],[<minecraft:soul_sand>, <minecraft:soul_sand>, <minecraft:soul_sand>], [null, <minecraft:soul_sand>, null]]);
