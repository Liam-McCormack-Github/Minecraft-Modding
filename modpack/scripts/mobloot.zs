<entity:minecraft:wither_skeleton>.removeDrop(<minecraft:bone>);
<entity:minecraft:wither_skeleton>.removeDrop(<extrautils2:ingredients:10>);
<entity:minecraft:wither_skeleton>.addDrop(<zcontent:wither_bone>, 1, 2);
